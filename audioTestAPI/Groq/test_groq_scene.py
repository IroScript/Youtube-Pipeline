...
RULES FOR VEO 3.1:
1. The user ONLY has access to 4s and 6s video generations. DO NOT assign 8s or 10s.
...
4. If a scene's audio duration is too long to fit in 6s (e.g. requires 8s or 10s), you MUST break it down into smaller scenes. 
5. Write a highly detailed, cinematic visual prompt (no audio/narration mentioned).
...
print("Sending request to Groq API using model llama-3.3-70b-versatile ...")
import io
...
try:
    ...
    output_file = r"C:\Users\Irak\Desktop\Youtube Pipeline\scene_prompts_groq.md"
